...
#ifndef KDL_MOTION_MOTIONPROFILE_TRAP_H
#define KDL_MOTION_MOTIONPROFILE_TRAP_H
...
namespace KDL {
	...
	/**
	 * A Trapezoidal MotionProfile implementation.
	 * @ingroup Motion
	 */
class MotionProfile_Trap : public MotionProfile
	...
	public:
		...
		// trajectory.
		static int Create(	MotionProfileTrapPtr& profile,
							double _maxvel=0,
							double _maxacc=0);
