 ...
 */
class ChainIkSolverPos_LMA_JL : public KDL::ChainIkSolverPos
{
private:
...
public:
    ...
    /**
	 * \brief constructs an ChainIkSolverPos_LMA_JL solver.
	 *
    ...
    /**
     * \brief identical the full constructor for ChainIkSolverPos_LMA_JL, but provides for a default weight matrix.
     *
     ...
     * \brief destructor.
     */
    virtual ~ChainIkSolverPos_LMA_JL();
